...
Télécharger les données de manchots de Palmers `penguins.csv` disponibles sur la page des [jeux de données ](https://dsr-rennes.github.io/https://agrocampusds.github.io/demarche_statistique/index.html#scripts-et-donn%C3%A9es) ainsi que le fichier `TD1_script.R` dans le répertoire Téléchargement par défaut.

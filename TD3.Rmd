...
Le gain moyen quotidien (GMQ) est défini comme la moyenne sur une période des prises de poids. C'est un indicateur courant pour les élevages bovins pour la simple raison qu'un GMQ élevé garantit une carcasse plus lourde, donc plus rentable. Les données sont fournies dans le fichier `vaches.csv`.

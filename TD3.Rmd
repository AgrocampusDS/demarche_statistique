...
La commande `geom_boxplot`  n'a pas le comportement attendue car `R` traite la variable `Localisation`, un entier compris entre 1 et 7 comme une varaible quantitative. 

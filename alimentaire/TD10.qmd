...
Importer les données de [jambon.txt](https://agrocampusds.github.io/demarche_statistique/alimentaire/data/jambon.txt) grâce à la commande suivante :
```{r}
...
Importer les données de [chocolat2017.csv](https://agrocampusds.github.io/demarche_statistique/alimentaire/data/chocolat2017.csv) en utilisant les lignes de code suivantes qui permettent d'importer et ensuite de transformer les trois premières variables en facteurs :

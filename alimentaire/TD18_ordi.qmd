...
On veut choisir un emballage pour une nouvelle recette de crème caramel. Plusieurs critères (7) sont étudiés : parfum/marque (parfum caramel écrit en gros ou marque écrite en gros) ; DLC (indiquée sur le couvercle ou le côté) ; mention “le magnésium est bon pour la santé” (indiquée ou non) ; mention “fabriqué en France” (indiquée ou non) ; couleur (une seule ou plusieurs couleurs) ; taille des caractères (petite ou grande) ; fond (avec ou sans photo en fond).

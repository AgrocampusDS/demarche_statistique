...
Reprenons la même problématique d'élevage bovin que dans le TD précédent. 

* Combien de vaches étudier pour réussir à détecter un écart d'environ 100g entre les gains moyens théoriques des Charolaises et des Limousines ?

* Quelle est la différence de  gains moyens théoriques entre ces races de vache que l'on peut détecter au risque 90% ?

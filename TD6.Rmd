...
```{r import_data_V1}
data.sport.V1 <- read.table('dataSportV1.csv', sep = ';' , stringsAsFactors = TRUE, header = TRUE)
```
...
```{r import_data_V2}
data.sport.V2 <- read.table('dataSportV2.csv', sep = ';' , stringsAsFactors = TRUE, header = TRUE)
```

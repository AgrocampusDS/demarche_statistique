...
* Utiliser la fonction graphique `geom_point` en précisant bien les abscisses et les ordonnées pour obtenir une visulaisation du lien entre  la longueur des nageaoires sur la longueur du bec.

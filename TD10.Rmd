...
```{r facultatif, fig.show='asis', fig.cap="
* La ligne bleue indique le taux de Glucose moyen prédit par le modèle en fonction de l'indice a
* La zone grisée représente l'intervalle de confiance pour ce taux moyen
* Les deux lignes pointillées rouges délimitent le taux de Glucose prédit pour un abricot selon son indice a"}

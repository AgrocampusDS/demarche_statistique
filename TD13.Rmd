---
title: "TD13 : Etude de cas : analyse des surfaces d'algues échouées"
...
L'agence de l'eau Eau-Seine-Normandie s'intéresse aux échouages d'algues vertes et d'algues rouges-brunes sur la côte normande. La surface d'échouage des algues a été mesurée sur quatre sites d'échouage, à 3 périodes de l'année et sur 14 ans et pour les 2 types d'algues (voir les données dans le jeu `donnees_echouages.csv`).
...
mod <- LinearModel(data = algues, Surface..ha. ~ Algues*(Annee + Mois + Site))
mod$Ftest

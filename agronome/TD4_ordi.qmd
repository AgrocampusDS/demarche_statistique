---
title: "TD 4 - Test de comparaison de moyennes"
format: html
---
...
On reprend les données sur le carbone organique dissout (COD). On s’intéresse dans un premier temps au percentile 90 du COD.
...
Dans un premier temps, on s’intéresse aux données du bassin parisien uniquement. Pour cela, on filtre les données et on construit un objet `dta_bassin` qui contient uniquement les stations du bassin parisien.
...
1. Donner l’intervalle de confiance du carbone organique dissout pour les stations du bassin parisien. A quoi cet intervalle correspond-il ?
...
4. Construire maintenant l’intervalle de confiance du phosphore total pour les stations du massif armoricain uniquement.
...
6. Comparez les largeurs des deux intervalles de confiance (bassin parisien vs massif armoricain). Quelle(s) raison(s) peut/peuvent expliquer la différence de largeur ?

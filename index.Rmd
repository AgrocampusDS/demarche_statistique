...
- [Abricots](abricotsSG.txt) : données sur la maturité des abricots,
...
- [Manchots de Palmer](penguins.csv) : ce jeu de données est distribué dans le package [palmerpenguins](https://allisonhorst.github.io/palmerpenguins/) d'Allison Horst <img src="https://allisonhorst.github.io/palmerpenguins/reference/figures/logo.png" alt="manchot" height="100"/>
...
* puis installer l'environnement [RStudio](https://www.rstudio.com/products/rstudio/download/)

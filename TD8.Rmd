...
```{r import_data}
dta <- read.table('C:/Users/husson/AOBox/TD_2021_partage/puissance_1.csv', sep = ';' , stringsAsFactors = TRUE, header = TRUE)
```
...
```{r}
dta2 <- read.table('C:/Users/husson/AOBox/TD_2021_partage/puissance_2.csv', sep = ';' , stringsAsFactors = TRUE, header = TRUE)
```
